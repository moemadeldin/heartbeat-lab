<div class="w-full max-w-md space-y-8">
    ...
    <div class="text-center">
        ...
        <h2 class="text-4xl font-extrabold tracking-tight text-white">Get Started</h2>
        <p class="mt-2 text-slate-400">Create your account and start monitoring</p>
    </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-slate-400 text-sm">
                ...
                <a href="{{ route('login') }}" wire:navigate
                    class="text-blue-400 hover:text-blue-300 font-semibold">Sign in</a>
            </p>
        </div>
    </div>
</div>